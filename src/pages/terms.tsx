        ...
        <article>
            ...
            <Row className="mt-5">
                ...
                <Row className="mt-5 mb-5">
                    ...
                    Reunindo dados de contato fornecidos pelo usuário ao preencher o formulário de contato disponibilizado
                    na página de contato. Para que assim possamos retornar o contato e marcarmos uma consulta.
                    </p>
                    ...
                    <p>
                        ...
                        Nâo nos responsabilizamos por envio de dados incorretor por parte do usuário.
                    </p>
                    ...
                    <p>OBRIGAÇÕES DO WEBSITE</p>

                    <p>
                        Disponibilizar um meio seguro de contato com seus clientes que desejam marcar consultas.
                    </p>
                    ...
                    <p>
                        Na aba CONTATO você pode encontrar informações para nos contatar.
                    </p>

                    <p>ACEITAÇÃO DO TERMO DE USO</p>
                ...
                <Row className="mt-5">
                    <Col>
                        <h1 className="article-title">Declaração de Privacidade.</h1>
                    </Col>
                </Row>
                    ...
                    <Col className="article-text">
                        ...
                        <p>
                            3.1 Dados que você nos fornece
                                   Ao enviar um e-mail de contato, poderemos obter algumas informações sobre
                                    você, tais como:
                        </p>
                        ...
                        <p>
                            ...
                            4.1 Para retornar o seu contato e agendamento de concultas.
                            Podemos utilizar os dados coletados para prover uma forma eficiente de contato com você
                            e para o agendamento de consultas. Lembrando que quem entra em contato primeiro é você.
                        </p>
                        ...
                        <p>
                            Não, usamos seus dados de contatos apenas para fins de retorno de contato solicitado.
                        </p>
