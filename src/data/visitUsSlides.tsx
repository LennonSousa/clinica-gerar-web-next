...
export const slides: VisitUsSlide[] = [
    {
        ...
        cover: '/assets/images/visit-us/atendimento.jpg',
    },
    {
        id: 1,
        title: 'Entrada principal',
        description: 'Estamos no 5º andar, salar 501.',
        cover: '/assets/images/visit-us/entrada.jpg',
    },
    {
        id: 2,
        ...
        cover: '/assets/images/visit-us/exames.jpg',
    },
    {
        id: 3,
        title: 'Dr. Evaldo e Dra. Cristina',
        description: 'A melhor equipe para lhe atenter.',
        cover: '/assets/images/visit-us/medicos.jpg',
    },
    {
        id: 4,
        title: 'Quartos',
        description: 'Muito conforto e qualidade.',
        cover: '/assets/images/visit-us/quarto-01.jpg',
    },
    {
        id: 5,
        title: 'Leito',
        description: 'O melhor para você.',
        cover: '/assets/images/visit-us/quarto-02.jpg',
    },
    {
        id: 6,
        title: 'Corredores',
    ...
    },
    {
        ...
        cover: '/assets/images/visit-us/sala-procedimentos.jpg',
    },
    {
        id: 9,
        title: 'Sala de ultrassonografia',
        description: 'Os melhores equipamentos para o melhor exame.',
        cover: '/assets/images/visit-us/ultrassom.jpg',
    },
